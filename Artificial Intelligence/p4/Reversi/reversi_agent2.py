...
class Reversi:
	...
	def heuristics(self, move_num, my_player):
		...
		if self.board[0][0] == None:
			if self.board[0][1] == max_color: max_tiles += 3
			elif self.board[0][1] == 1 - max_color: min_tiles += 3
			if self.board[1][1] == max_color: max_tiles += 2
			elif self.board[1][1] == 1 - max_color: min_tiles += 2
			if self.board[1][0] == max_color: max_tiles += 1
			elif self.board[1][0] == 1 - max_color: min_tiles += 1
		if self.board[0][7] == None:
			if self.board[0][6] == max_color: max_tiles += 3
			elif self.board[0][6] == 1 - max_color: min_tiles += 3
			if self.board[1][6] == max_color: max_tiles += 2
			elif self.board[1][6] == 1 - max_color: min_tiles += 2
			if self.board[1][7] == max_color: max_tiles += 1
			elif self.board[1][7] == 1 - max_color: min_tiles += 1
		if self.board[7][0] == None:
			if self.board[7][1] == max_color: max_tiles += 3
			elif self.board[7][1] == 1 - max_color: min_tiles += 3
			if self.board[6][1] == max_color: max_tiles += 2
			elif self.board[6][1] == 1 - max_color: min_tiles += 2
			if self.board[6][0] == max_color: max_tiles += 1
			elif self.board[6][0] == 1 - max_color: min_tiles += 1
		if self.board[7][7] == None:
			if self.board[6][7] == max_color: max_tiles += 3
			elif self.board[6][7] == 1 - max_color: min_tiles += 3
			if self.board[6][6] == max_color: max_tiles += 2
			elif self.board[6][6] == 1 - max_color: min_tiles += 2
			if self.board[7][6] == max_color: max_tiles += 1
			elif self.board[7][6] == 1 - max_color: min_tiles += 1
		corner_closness_heuristic_value = -12.5 * (max_tiles - min_tiles)
		...
		return (2*move_num * coin_parity_heuristic_value) + (9000 * corners_captured_heuristic_value) + (382.026 * corner_closness_heuristic_value) + (783.922 * actual_mobility_heuristic_value) + (10 * static_score_heuristic_value) + (10 * stable_coins_heuristic_value)
...
class Player(object):
	...
	def find_best(self, depth, moves, TIME):
		...
		def alphabeta(state, depth, alpha, beta, maximizingPlayer, ile):
			...
			if maximizingPlayer == self.my_player:
				...
				for child in children(state, maximizingPlayer):
					eval = alphabeta(deepcopy(child), depth - 1, alpha, beta,1- maximizingPlayer, ile)
				...
				minEval = +inf
				for child in children(state, maximizingPlayer):
					eval = alphabeta(deepcopy(child), depth - 1, alpha, beta, maximizingPlayer, ile)
	...
	def loop(self):
		...
		while True:
			...
			if moves:
				...
				move = self.find_best(2, moves, TIME)
